...
new_aapl_record = {"date": new_records["AAPL"]["date"], "open": new_records["AAPL"]["open"], "high": new_records["AAPL"]["high"], "low": new_records["AAPL"]["low"], "close": new_records["AAPL"]["close"], }

new_mu_record = {"date": new_records["MU"]["date"], "open": new_records["MU"]["open"], "high": new_records["MU"]["high"], "low": new_records["MU"]["low"], "close": new_records["MU"]["close"], }

new_amd_record = {"date": new_records["AMD"]["date"], "open": new_records["AMD"]["open"], "high": new_records["AMD"]["high"], "low": new_records["AMD"]["low"], "close": new_records["AMD"]["close"], }

new_twtr_record = {"date": new_records["TWTR"]["date"], "open": new_records["TWTR"]["open"], "high": new_records["TWTR"]["high"], "low": new_records["TWTR"]["low"], "close": new_records["TWTR"]["close"], }

# print(new_aapl_record, new_mu_record, new_amd_record, new_twtr_record)
...
for key, value in new_records.items():
    temp_list = [value["date"], value["open"], value["high"], value["low"], value["close"]]
    historical_stock_data[key].append(temp_list)
